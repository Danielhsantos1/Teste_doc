    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm rounded-xl border border-border bg-card p-8">
        <div className="mb-8 text-center">
          <div className="text-2xl font-semibold text-gray-50">DocDeck</div>
        ...
        <div className="mt-6 rounded-lg border border-border bg-surface px-3 py-2 text-xs text-muted">
          ...
          (<code className="text-gray-300">admin@docdeck.demo</code> /{" "}
          <code className="text-gray-300">docdeck123</code>), dados marcados como DEMO DATA.
        </div>
      </div>
    </div>
  );
